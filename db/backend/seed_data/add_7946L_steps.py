"""
Script to add work center steps to the 7946L ASSY traveler
...
def add_work_center_steps():
    """Add work center steps to 7946L ASSY traveler"""
    ...
    try:
        # Find the 7946L ASSY traveler
        traveler = db.query(Traveler).filter(
            Traveler.job_number == "7946L ASSYL"
        ).first()

        if not traveler:
            print("❌ Traveler 7946L ASSYL not found!")
        ...
        # Define work center steps for 7946L ASSY
        work_center_steps = [
            {
                "step_number": 1,
            ...
            },
            {
                "step_number": 4,
                "operation": "PREPARE",
                "work_center_code": "PREPARE",
                "instructions": "Prepare board for soldering",
                "estimated_time": 30,
                "is_required": True
            },
            {
                "step_number": 5,
                "operation": "AUTO INSERT",
        ...
        db.commit()
        print(f"\n✅ Successfully added {len(work_center_steps)} work center steps to traveler 7946L ASSYL!")
